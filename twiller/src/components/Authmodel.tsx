...
import {X, EyeOff, Lock, User, Eye, Mail } from "lucide-react";
import { Input } from "./ui/input";

import TwitterLogo from "./loading-spinner";
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    onChange={(e: { target: { value: string; }; }) => handleInputChange('password', e.target.value)}
